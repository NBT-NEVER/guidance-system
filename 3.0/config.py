...
文件名: config.py
功能说明: 追踪法实验三 配置文件 / Configuration for tracking experiment.
"""
...
EXPERIMENT = {'title': '实验三（容易）：追踪法导引方法—不同初始弹目相对距离对导引弹道的影响',
'mode': 'range_sweep',
'dt': 0.01,
't_max_s': 100.0,
'hit_radius_m': 5.0,
...
'initial_range_values_m': [1000.0, 2000.0, 5000.0, 7500.0, 10000.0, 15000.0, 20000.0]}
