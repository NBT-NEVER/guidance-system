...
文件名: config.py
功能说明: 追踪法实验二 配置文件 / Configuration for tracking experiment.
"""
...
EXPERIMENT = {'title': '实验二（容易）：追踪法导引方法—不同初始目标视线角对导引弹道的影响',
'mode': 'los_angle_sweep',
'dt': 0.01,
't_max_s': 80.0,
'hit_radius_m': 5.0,
'max_overload_g': 20.0,
'base_scenario': {'initial_range_m': 5000.0,
           'initial_los_deg': 30.0,
           'target_heading_deg': 0.0,
           'target_speed_mps': 272.0,
           'missile_speed_mps': 408.0},
'initial_los_values_deg': [0.0, 30.0, 60.0, 90.0, 120.0, 150.0, 170.0, 175.0]}
