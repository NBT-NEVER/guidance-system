...
文件名: config.py
功能说明: 三点法实验三 配置文件 / Configuration for three-point experiment.
"""
...
EXPERIMENT = {'title': '实验三（困难）：对比目标机动条件下，三点法、前置量法与半前置量法的影响',
'mode': 'law_compare_maneuver',
'dt': 0.01,
't_max_s': 80.0,
'hit_radius_m': 10.0,
'max_overload_g': 20.0,
'baseline_gains': {'k_e': 1.2, 'k_d': 0.8, 'k_c': 0.6},
'law_map': {'三点法': 0.0, '前置量法': 1.0, '半前置量法': 0.5},
'base_scenario': {'missile_position_m': [2100.0, 2100.0],
           'target_position_m': [5300.0, 5300.0],
           'missile_velocity_mps': [320.0, 320.0],
           'target_velocity_mps': [240.0, 0.0]},
'target_normal_g_values': [1, 2, 3, 4, 5]}
