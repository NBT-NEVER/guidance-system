...
文件名: config.py
功能说明: 三点法实验五 配置文件 / Configuration for three-point experiment.
"""
...
EXPERIMENT = {'title': '实验五（困难）：考虑姿态控制回路的三点法仿真',
'mode': 'attitude_compare',
'dt': 0.01,
't_max_s': 80.0,
'hit_radius_m': 10.0,
'max_overload_g': 10.0,
...
'attitude_loop': {'zeta': 0.707, 'omega_n': 10.0}}
